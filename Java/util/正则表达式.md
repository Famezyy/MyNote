...
![image2](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMi5wbmc=)
...
![image4](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlNC5wbmc=)
...
![image4](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlNS5wbmc=)
...
![image](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlNi5wbmc=)

可以通过在字符数组开头使用 `^` 字符实现取反操作，从而可以反转一个字符组（意味着会匹配任何指定字符之外的所有字符）。

再看一个例子：

![image](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlNy5wbmc=)
...
![image8](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlOC5wbmc=)

### 3.单词边界

`\b` 匹配的是**单词的边界**，例如，

![image9](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlOS5wbmc=)

`\bmaster\b` 就仅匹配有边界的`master`单词。

当然其他类型的数据，比如数字也能匹配：

![image9](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTAucG5n)
...
![image11](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTEucG5n)
...
![image](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTIucG5n)

指定字符串的结束：

![image](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTMucG5n)
...
![image](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTQucG5n)
...
![image](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTUucG5n)
...
![image16](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTYucG5n)
...
![image](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTcucG5n)
...
![img](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTgucG5n)

### 3.开闭区间

有时候我们可能遇到字符组的重复次数没有边界，例如：

![image](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTkucG5n)
...
![image](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMjAucG5n)

`*`号示例：

![image](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMjEucG5n)
...
![image](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL2ltYWdlMS5wbmc=)

这段正则表达式将文本**分成了两组**，第一组为：`0731`，第二组为`8825951`。

![image](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL2ltYWdlMi5wbmc=)
...
![image](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL29yLnBuZw==)
...
![image](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL-mdnuaNleiOty5wbmc=)
...
![image](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL2ltYWdlNS5wbmc=)
...
![image](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL2ltYWdlNi5wbmc=)

这确实可以匹配，不过可能还有另一种情况，如果数据改成这样：`<font>提示</bar>`

![image](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL2ltYWdlNy5wbmc=)
...
![image](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL2ltYWdlOC5wbmc=)
...
![start](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL-WFiOihjOaWreiogC5wbmc=)

**提取包含大小写字母的字符串**

先行断言可以用来判断字符串是否符合特定的规则，例如提取包含至少一个大小写字母的字符串：

![start](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL-WFiOihjOaWreiogDIucG5n)

`(?=.*?[a-z])(?=.*?[A-Z]).+` 这段正则表达式规定了匹配的字符串中必须包含**至少一个大写和小写的字母**。都表示在开头位置向右看。

判断第一个字符大写，第二个小写：

![image-20220123173656864](H:\笔记\Java\util\img\image-20220123173656864.png)
...
![start](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL-WPjeWQkeWFiOihjC5wbmc=)
...
![img](H:\笔记\Java\util\img\cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL-ato-WQkeWQjuihjOaWreiogC5wbmc=)
...
<img src="H:\笔记\Java\util\img\image-20220123163405658.png" alt="image-20220123163405658" style="zoom:67%;" />
