...
![image2](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMi5wbmc=)
...
![image4](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlNC5wbmc=)
...
![image4](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlNS5wbmc=)
...
![image](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlNi5wbmc=)

可以通过在字符数组开头使用 `^` 字符实现取反操作，从而可以反转一个字符组（意味着会匹配任何指定字符之外的所有字符）。

再看一个例子：

![image](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlNy5wbmc=)
...
![image8](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlOC5wbmc=)

### 3.单词边界

`\b` 匹配的是**单词的边界**，例如，

![image9](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlOS5wbmc=)

`\bmaster\b` 就仅匹配有边界的`master`单词。

当然其他类型的数据，比如数字也能匹配：

![image9](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTAucG5n)
...
![image11](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTEucG5n)
...
![image](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTIucG5n)

指定字符串的结束：

![image](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTMucG5n)
...
![image](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTQucG5n)
...
![image](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTUucG5n)
...
![image16](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTYucG5n)
...
![image](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTcucG5n)
...
![img](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTgucG5n)

### 3.开闭区间

有时候我们可能遇到字符组的重复次数没有边界，例如：

![image](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMTkucG5n)
...
![image](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMjAucG5n)

`*`号示例：

![image](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjEvaW1hZ2VzL2NoYXB0ZXIxL2ltYWdlMjEucG5n)
...
![image](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL2ltYWdlMS5wbmc=)

这段正则表达式将文本**分成了两组**，第一组为：`0731`，第二组为`8825951`。

![image](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL2ltYWdlMi5wbmc=)
...
![image](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL29yLnBuZw==)
...
![image](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL2ltYWdlNS5wbmc=)

![image](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL2ltYWdlNC5wbmc=)
...
![start](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL-WFiOihjOaWreiogC5wbmc=)
...
![image-20220123173656864](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20220123173656864.png)
...
![start](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL-WPjeWQkeWFiOihjC5wbmc=)
...
![img](https://cdn.codejiaonang.com/download/cmVnZXhfY2hhcHRlcjIvaW1hZ2VzL2NoYXB0ZXIyL-ato-WQkeWQjuihjOaWreiogC5wbmc=)
...
<img src="C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20220123163405658.png" alt="image-20220123163405658" style="zoom:67%;" />
