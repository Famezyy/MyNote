...
```bash
root@VM-0-4-ubuntu:~# kubectl create secret generic mysql-root-authn --from-literal=username=root --from-literal=password=root
...
```bash
root@VM-0-4-ubuntu:~# echo "cm9vdA==" | base64 -d
root
```
